...
import com.gdgdevfest.android.apps.devfestsur.appwidget.ScheduleWidgetProvider;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.Announcements;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.Blocks;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.Feedback;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.MapMarkers;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.MapTiles;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.Rooms;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.Sandbox;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.SearchSuggest;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.Sessions;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.Speakers;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleContract.Tracks;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleDatabase.SessionsSearchColumns;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleDatabase.SessionsSpeakers;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleDatabase.SessionsTracks;
import com.gdgdevfest.android.apps.devfestsur.provider.ScheduleDatabase.Tables;
import com.gdgdevfest.android.apps.devfestsur.util.SelectionBuilder;

import static com.gdgdevfest.android.apps.devfestsur.util.LogUtils.*;

/**
 * Provider that stores {@link ScheduleContract} data. Data is usually inserted
 * by {@link com.gdgdevfest.android.apps.devfestsur.sync.SyncHelper}, and queried by various
